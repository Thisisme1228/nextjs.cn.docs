...
In this case, you should add a top-level import for the **specific polyfill** you need in your [Custom `<App>`](/docs/content/pages/building-your-application/routing/custom-app) or the individual component.
...
Next.js has built-in TypeScript support. [Learn more here](/docs/content/pages/building-your-application/configuring/typescript).

### Customizing Babel Config (Advanced)

You can customize babel configuration. [Learn more here](/docs/content/pages/building-your-application/configuring/babel).
