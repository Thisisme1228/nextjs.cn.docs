...
- `props` - An object containing the parameters of the current route:
  ...
  - `params` - An object containing the [dynamic route parameters](/docs/content/app/building-your-application/routing/dynamic-routes) object from the root segment down to the segment `generateMetadata` is called from. Examples:
...
> - The [`redirect()`](/docs/content/app/api-reference/functions/redirect) and [`notFound()`](/docs/content/app/api-reference/functions/not-found) Next.js methods can also be used inside `generateMetadata`.
...
> **Deprecated**: The `themeColor` option in `metadata` is deprecated as of Next.js 14. Please use the [`viewport` configuration](/docs/content/app/api-reference/functions/generate-viewport) instead.
...
> **Deprecated**: The `viewport` option in `metadata` is deprecated as of Next.js 14. Please use the [`viewport` configuration](/docs/content/app/api-reference/functions/generate-viewport) instead.
...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<meta http-equiv="...">`     | Use appropriate HTTP Headers via [`redirect()`](/docs/content/app/api-reference/functions/redirect), [Middleware](/docs/content/app/building-your-application/routing/middleware#nextresponse), [Security Headers](/docs/content/app/api-reference/next-config-js/headers) |
| `<base>`                      | Render the tag in the layout or page itself.                                                                                                                                                                                                                               |
| `<noscript>`                  | Render the tag in the layout or page itself.                                                                                                                                                                                                                               |
| `<style>`                     | Learn more about [styling in Next.js](/docs/content/app/building-your-application/styling/css).                                                                                                                                                                            |
| `<script>`                    | Learn more about [using scripts](/docs/content/app/building-your-application/optimizing/scripts).                                                                                                                                                                          |
...
You can add type safety to your metadata by using the `Metadata` type. If you are using the [built-in TypeScript plugin](/docs/content/app/building-your-application/configuring/typescript) in your IDE, you do not need to manually add the type, but you can still explicitly add it if you want.
...
| Version   | Changes                                                                                                                                                         |
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v13.2.0` | `viewport`, `themeColor`, and `colorScheme` deprecated in favor of the [`viewport` configuration](/docs/content/app/api-reference/functions/generate-viewport). |
