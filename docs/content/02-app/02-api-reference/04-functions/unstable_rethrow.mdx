...
For example, calling the `notFound` function will throw an internal Next.js error and render the [`not-found.js`](/docs/content/app/api-reference/file-conventions/not-found) component. However, if used inside a `try/catch` block, the error will be caught, preventing `not-found.js` from rendering:
...
- [`notFound()`](/docs/content/app/api-reference/functions/not-found)
- [`redirect()`](/docs/content/app/building-your-application/routing/redirecting#redirect-function)
- [`permanentRedirect()`](/docs/content/app/building-your-application/routing/redirecting#permanentredirect-function)
...
- [`searchParams`](/docs/content/app/api-reference/file-conventions/page#searchparams-optional)
