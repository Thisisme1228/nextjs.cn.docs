...
The `mdx-components.js|tsx` file is **required** to use [`@next/mdx` with App Router](/docs/content/app/building-your-application/configuring/mdx) and will not work without it. Additionally, you can use it to [customize styles](/docs/content/app/building-your-application/configuring/mdx#using-custom-styles-and-components).
