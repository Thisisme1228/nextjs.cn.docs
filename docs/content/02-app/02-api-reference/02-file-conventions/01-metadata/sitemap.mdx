...
> **Good to know**: `sitemap.js` is a special Route Handlers that is cached by default unless it uses a [dynamic function](/docs/content/app/building-your-application/caching#dynamic-functions) or [dynamic config](/docs/content/app/building-your-application/caching#segment-config-options) option.
...
- By using the [`generateSitemaps`](/docs/content/app/api-reference/functions/generate-sitemaps) function.
...
See the [`generateSitemaps` API reference](/docs/content/app/api-reference/functions/generate-sitemaps) for more information.
