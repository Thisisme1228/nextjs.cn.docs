...
> Good to know: `manifest.js` is special Route Handlers that is cached by default unless it uses a [dynamic function](/docs/content/app/building-your-application/caching#dynamic-functions) or [dynamic config](/docs/content/app/building-your-application/caching#segment-config-options) option.
