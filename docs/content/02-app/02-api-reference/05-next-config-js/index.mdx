...
If you are using TypeScript in your project, you can use [`next.config.ts`](/docs/content/app/building-your-application/configuring/typescript#type-checking-nextconfigts) to use TypeScript in your configuration:
