...
The experimental `instrumentationHook` option allows you to set up instrumentation via the [`instrumentation` file](/docs/content/app/api-reference/file-conventions/instrumentation) in your Next.js App.
