...
You can use `process.env` to access [Environment Variables](/docs/content/app/building-your-application/configuring/environment-variables) for both `next dev` and `next build`.
