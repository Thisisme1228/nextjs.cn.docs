...
This API reference will help you understand how to use [`next/font/google`](/docs/content/app/building-your-application/optimizing/fonts#google-fonts) and [`next/font/local`](/docs/content/app/building-your-application/optimizing/fonts#local-fonts). For features and usage, please see the [Optimizing Fonts](/docs/content/app/building-your-application/optimizing/fonts) page.

### Font Function Arguments

For usage, review [Google Fonts](/docs/content/app/building-your-application/optimizing/fonts#google-fonts) and [Local Fonts](/docs/content/app/building-your-application/optimizing/fonts#local-fonts).

| Key                                         | `font/google` | `font/local` | Type                       | Required          |
| ------------------------------------------- | ------------- | ------------ | -------------------------- | ----------------- |
| [`src`](#src)                               | ❌            | ✔️           | String or Array of Objects | Yes               |
| [`weight`](#weight)                         | ✔️            | ✔️           | String or Array            | Required/Optional |
| [`style`](#style)                           | ✔️            | ✔️           | String or Array            | -                 |
| [`subsets`](#subsets)                       | ✔️            | ❌           | Array of Strings           | -                 |
| [`axes`](#axes)                             | ✔️            | ❌           | Array of Strings           | -                 |
| [`display`](#display)                       | ✔️            | ✔️           | String                     | -                 |
| [`preload`](#preload)                       | ✔️            | ✔️           | Boolean                    | -                 |
| [`fallback`](#fallback)                     | ✔️            | ✔️           | Array of Strings           | -                 |
| [`adjustFontFallback`](#adjustfontfallback) | ✔️            | ✔️           | Boolean or String          | -                 |
| [`variable`](#variable)                     | ✔️            | ✔️           | String                     | -                 |
| [`declarations`](#declarations)             | ❌            | ✔️           | Array of Objects           | -                 |
...
The font [`subsets`](https://fonts.google.com/knowledge/glossary/subsetting) defined by an array of string values with the names of each subset you would like to be [preloaded](/docs/content/app/building-your-application/optimizing/fonts#specifying-a-subset). Fonts specified via `subsets` will have a link preload tag injected into the head when the [`preload`](#preload) option is true, which is the default.
...
A boolean value that specifies whether the font should be [preloaded](/docs/content/app/building-your-application/optimizing/fonts#preloading) or not. The default is `true`.
