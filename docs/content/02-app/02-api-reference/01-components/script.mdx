...
This API reference will help you understand how to use [props](#props) available for the Script Component. For features and usage, please see the [Optimizing Scripts](/docs/content/app/building-your-application/optimizing/scripts) page.
