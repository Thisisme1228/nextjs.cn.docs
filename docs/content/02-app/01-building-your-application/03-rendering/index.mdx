...
Understanding these differences is key to effectively using React and Next.js. We'll cover the differences and use cases in more detail on the [Server](/docs/content/app/building-your-application/rendering/server-components) and [Client](/docs/content/app/building-your-application/rendering/client-components) Components pages, for now, let's continue building on our foundation.
...
This concept will become clearer when we look at how you can [interleave client and server components](/docs/content/app/building-your-application/rendering/composition-patterns) in the same component tree.
