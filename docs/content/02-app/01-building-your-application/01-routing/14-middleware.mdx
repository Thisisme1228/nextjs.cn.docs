...
1. `rewrite` to a route ([Page](/docs/content/app/building-your-application/routing/layouts-and-templates) or [Route Handler](/docs/content/app/building-your-application/routing/route-handlers)) that produces a response
...
1. `rewrite` to a route ([Page](/docs/content/pages/building-your-application/routing/pages-and-layouts) or [Edge API Route](/docs/content/pages/building-your-application/routing/api-routes)) that produces a response
2. return a `NextResponse` directly. See [Producing a Response](#producing-a-response)
...
> **Good to know:** You can configure CORS headers for individual routes in [Route Handlers](/docs/content/app/building-your-application/routing/route-handlers#cors).
