...
The `redirect` function allows you to redirect the user to another URL. You can call `redirect` in [Server Components](/docs/content/app/building-your-application/rendering/server-components), [Route Handlers](/docs/content/app/building-your-application/routing/route-handlers), and [Server Actions](/docs/content/app/building-your-application/data-fetching/server-actions-and-mutations).
...
The `permanentRedirect` function allows you to **permanently** redirect the user to another URL. You can call `permanentRedirect` in [Server Components](/docs/content/app/building-your-application/rendering/server-components), [Route Handlers](/docs/content/app/building-your-application/routing/route-handlers), and [Server Actions](/docs/content/app/building-your-application/data-fetching/server-actions-and-mutations).
...
See the [`permanentRedirect` API reference](/docs/content/app/api-reference/functions/permanentRedirect) for more information.
...
> **Good to know**:
>
> - If you don't need to programmatically navigate a user, you should use a [`<Link>`](/docs/content/app/api-reference/components/link) component.

<AppOnly>

See the [`useRouter` API reference](/docs/content/app/api-reference/functions/use-router) for more information.

</AppOnly>

<PagesOnly>

See the [`useRouter` API reference](/docs/content/pages/api-reference/functions/use-router) for more information.
...
`redirects` supports [path](/docs/content/app/api-reference/next-config-js/redirects#path-matching), [header, cookie, and query matching](/docs/content/app/api-reference/next-config-js/redirects#header-cookie-and-query-matching), giving you the flexibility to redirect users based on an incoming request.
...
See the [`redirects` API reference](/docs/content/app/api-reference/next-config-js/redirects) for more information.

> **Good to know**:
>
> - `redirects` can return a 307 (Temporary Redirect) or 308 (Permanent Redirect) status code with the `permanent` option.
> - `redirects` may have a limit on platforms. For example, on Vercel, there's a limit of 1,024 redirects. To manage a large number of redirects (1000+), consider creating a custom solution using [Middleware](/docs/content/app/building-your-application/routing/middleware). See [managing redirects at scale](#managing-redirects-at-scale-advanced) for more.
...
See the [Middleware](/docs/content/app/building-your-application/routing/middleware) documentation for more information.
