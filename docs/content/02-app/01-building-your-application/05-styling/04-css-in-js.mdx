...
If you want to style Server Components, we recommend using [CSS Modules](/docs/content/app/building-your-application/styling/css) or other solutions that output CSS files, like PostCSS or [Tailwind CSS](/docs/content/app/building-your-application/styling/tailwind-css).
...
Then, wrap your [root layout](/docs/content/app/building-your-application/routing/layouts-and-templates#root-layout-required) with the registry:
...
> - For advanced use cases where you need to configure individual properties of styled-components compilation, you can read our [Next.js styled-components API reference](/docs/content/architecture/nextjs-compiler#styled-components) to learn more.
