...
View the [API Reference](/docs/content/pages/api-reference/functions/use-report-web-vitals) for more information.
...
View the [API Reference](/docs/content/app/api-reference/functions/use-report-web-vitals) for more information.
