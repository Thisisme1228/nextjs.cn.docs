...
For static metadata files, such as `robots.txt`, `favicon.ico`, etc, you should use [special metadata files](/docs/content/app/api-reference/file-conventions/metadata) inside the `app` folder.
