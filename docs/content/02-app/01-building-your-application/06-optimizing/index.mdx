...
Additionally, you can create dynamic Open Graph Images using JSX and CSS with [imageResponse](/docs/content/app/api-reference/functions/image-response) constructor.
...
For large applications, Next.js integrates with popular analytics and monitoring tools to help you understand how your application is performing. Learn more in the <PagesOnly>[Analytics](/docs/content/app/building-your-application/optimizing/analytics), </PagesOnly> [OpenTelemetry](/docs/content/pages/building-your-application/optimizing/open-telemetry)<PagesOnly>,</PagesOnly> and [Instrumentation](/docs/content/pages/building-your-application/optimizing/instrumentation) guides.
