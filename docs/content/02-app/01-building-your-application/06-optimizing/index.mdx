...
For large applications, Next.js integrates with popular analytics and monitoring tools to help you understand how your application is performing. Learn more in the [OpenTelemetry](/docs/content/pages/building-your-application/optimizing/open-telemetry) and [Instrumentation](/docs/content/pages/building-your-application/optimizing/instrumentation) guides.
