...
> - Learn more about the [`mdx-components.tsx` file convention](/docs/content/app/api-reference/file-conventions/mdx-components).
...
In App Router apps, that includes being able to use [metadata](/docs/content/app/building-your-application/optimizing/metadata).
...
To share a layout across MDX pages, you can use the [built-in layouts support](/docs/content/app/building-your-application/routing/layouts-and-templates#layouts) with the App Router.
...
> **Good to know**:
>
> This option is required when processing markdown and MDX while using [Turbopack](/docs/content/architecture/turbopack) (`next dev --turbo`).
