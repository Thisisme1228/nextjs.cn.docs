...
Explicitly opt-out certain packages from being bundled using the [`serverExternalPackages`](/docs/content/pages/api-reference/next-config-js/serverExternalPackages) option.
