...
Opt-out specific dependencies from being included in the automatic bundling of the [`bundlePagesRouterDependencies`](/docs/content/pages/api-reference/next-config-js/bundlePagesRouterDependencies) option.
