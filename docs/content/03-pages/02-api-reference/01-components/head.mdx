...
We recommend using [`next/script`](/docs/content/pages/building-your-application/optimizing/scripts) in your component instead of manually creating a `<script>` in `next/head`.
