...
Next.js compiles CSS for its [built-in CSS support](/docs/content/pages/building-your-application/styling) using PostCSS.
...
You can learn more about [Next.js' CSS Module support here](/docs/content/pages/building-your-application/styling).
