...
> **Good to know**: If you are using the App Router, you can use [Server Components](/docs/content/app/building-your-application/rendering/server-components) or [Route Handlers](/docs/content/app/building-your-application/routing/route-handlers) instead of API Routes.
...
- API Routes can't be used with [static exports](/docs/content/pages/building-your-application/deploying/static-exports). However, [Route Handlers](/docs/content/app/building-your-application/routing/route-handlers) in the App Router can.
  > - API Routes will be affected by [`pageExtensions` configuration](/docs/content/pages/api-reference/next-config-js/pageExtensions) in `next.config.js`.
...
- `res.revalidate(urlPath)` - [Revalidate a page on demand](/docs/content/pages/building-your-application/data-fetching/incremental-static-regeneration#on-demand-revalidation) using `getStaticProps`. `urlPath` must be a `string`.
...
API Routes support [dynamic routes](/docs/content/pages/building-your-application/routing/dynamic-routes), and follow the same file naming rules used for `pages/`.
...
If you would like to use API Routes with the Edge Runtime, we recommend incrementally adopting the App Router and using [Route Handlers](/docs/content/app/building-your-application/routing/route-handlers) instead.
